...
function HotelsByGrid() {
    const body = ({ mapping }) => {
        return <img src={mapping} alt="hamzadev" className="rounded-lg h-56 w-full object-cover " />
    }
                ...
                data.map((hotel, index) => {
                        ...
                        return (<div className=" col-span-1 rounded-xl hover:shadow z-10  " key={index}>
                            ...
                            <div className=" pt-3 p-1">
                                ...
                                <div className=" py-2">
                                <Link to={`/hotel/select/${hotel._id}`} className={"text-blue-500 flex items-center gap-2 w-fit p-1 text-sm font-bold"}>Let's Visit  <FontAwesomeIcon icon={freeSolidSvgIcons.faArrowRight} />   </Link>
