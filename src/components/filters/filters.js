...
function Fitlers() {
  return (
    <div className=" relative hidden md:block ">
          <div className="w-full absolute top-1/2 border-b-2 border-black   "> </div>
      <div className=" grid md:grid-cols-5  grid-cols-2 sm:grid-cols-3 gap-3  p-1 py-3 w-fit m-auto  ">
