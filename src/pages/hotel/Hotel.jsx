...
[])
  ...
  return (
    <div className="bgzlij bg-scroll h-full">
      ...
      {!loading && error.message ? (
        ...
        <div className="">
          ...
          {loading ? (
            ...
            <div className=" container m-auto bg-gray-100  shadow-lg mt-10 rounded-2xl p-2  relative">
            
                <div>
                  
                  <h1 className="text-2xl p-2">Tower Street Apartments</h1>
